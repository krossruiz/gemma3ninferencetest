...
console.log("Is this even working? Start of js.");
...
const modelFileName = 'gemma-3n-E2B-it-int4.task'; /* Update the file name */
...
async function runDemo() {
  ...
  LlmInference
      ...
      .catch((error) => {
        console.error('Failed to initialize the task:', error);
        alert('Failed to initialize the task. Check error log.');
      });
}
